...
public class PricePlanComparatorControllerTest {
    ...
    public void shouldCalculateCostForMeterReadingsForEveryPricePlan() {
        ...
        ElectricityReading electricityReading = new ElectricityReading(LocalDateTime.now().minusSeconds(3600), BigDecimal.valueOf(15.0));
        ElectricityReading otherReading = new ElectricityReading(LocalDateTime.now(), BigDecimal.valueOf(5.0));
    ...
    public void shouldRecommendCheapestPricePlansNoLimitForMeterUsage() throws Exception {
        ...
        ElectricityReading electricityReading = new ElectricityReading(LocalDateTime.now().minusSeconds(1800), BigDecimal.valueOf(35.0));
        ElectricityReading otherReading = new ElectricityReading(LocalDateTime.now(), BigDecimal.valueOf(3.0));
        meterReadingService.storeReadings(SMART_METER_ID, Arrays.asList(electricityReading, otherReading));
    ...
    public void shouldRecommendLimitedCheapestPricePlansForMeterUsage() throws Exception {
        ...
        ElectricityReading electricityReading = new ElectricityReading(LocalDateTime.now().minusSeconds(2700), BigDecimal.valueOf(5.0));
        ElectricityReading otherReading = new ElectricityReading(LocalDateTime.now(), BigDecimal.valueOf(20.0));
        meterReadingService.storeReadings(SMART_METER_ID, Arrays.asList(electricityReading, otherReading));
    ...
    public void shouldRecommendCheapestPricePlansMoreThanLimitAvailableForMeterUsage() throws Exception {
        ...
        ElectricityReading electricityReading = new ElectricityReading(LocalDateTime.now().minusSeconds(3600), BigDecimal.valueOf(25.0));
        ElectricityReading otherReading = new ElectricityReading(LocalDateTime.now(), BigDecimal.valueOf(3.0));
        meterReadingService.storeReadings(SMART_METER_ID, Arrays.asList(electricityReading, otherReading));
